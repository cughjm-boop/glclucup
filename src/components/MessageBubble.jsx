...
import { synthesizeSpeech, synthesizeElevenLabs, stopSpeech } from '../services/tts'
...
export default function MessageBubble({ message, character }) {
  ...
  const handlePlayVoice = async () => {
    ...
    try {
      setIsPlaying(true)
      if (settings.ttsProvider === 'elevenlabs' && voiceSettings.clonedVoiceId) {
        await synthesizeElevenLabs(message.content, voiceSettings.clonedVoiceId, settings.elevenLabsApiKey)
      } else {
